...
;(function (g, f) {
  ...
  var Le = ((l = '') => {
    ...
    Xe = d(ke, 'gu')
      ...
      .getRegex(),
    Je = d(ke, 'gu')
      .replace(/notPunctSpace/g, Fe)
      .replace(/punctSpace/g, je)
      .replace(/punct/g, ce)
      .getRegex(),
    Ve = d(
    ...
    q = { normal: X, gfm: ve, pedantic: He },
    A = { normal: V, gfm: j, breaks: ut, pedantic: lt }
  var pt = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
    fe = (l) => pt[l]
  function O(l, e) {
    if (e) {
...
`
  ...
  var x = class l {
    ...
    constructor(e) {
      ...
      ;(this.options.pedantic
        ? ((t.block = q.pedantic), (t.inline = A.pedantic))
        : this.options.gfm &&
          ((t.block = q.gfm), this.options.breaks ? (t.inline = A.breaks) : (t.inline = A.gfm)),
      ...
      return (n, s) => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            ...
            let h = await (i.hooks ? await i.hooks.provideParser(e) : e ? b.parse : b.parseInline)(
              p,
              i
            )
