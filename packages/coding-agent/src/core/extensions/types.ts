...
export interface ExtensionUIContext {
  ...
  setWidget(
    key: string,
    content: ((...args: unknown[]) => unknown) | undefined,
...
export interface RegisteredCommand {
  ...
  getArgumentCompletions?:
    ((argumentPrefix: string) => string[] | null | Promise<string[] | null>) | undefined
...
export interface ExtensionAPI {
  ...
  on(
    event: 'desktop_panel_view_state_changed',
    handler: ExtensionHandler<DesktopPanelViewStateChangedEvent>
  ): void
   ...
   */
  registerMessageRenderer<TDetails = unknown>(
    customType: string,
    renderer: LegacyMessageRenderer<TDetails>
  ): void
