...
Desktop 可以增加索引、缓存、thread worker registry、IPC、数据库和 UI-friendly projection，
...
packages/coding-agent
  ...
  thread worker registry types / utility worker runtime
...
2. Desktop control protocol：thread worker registry、thread registry、窗口订阅、数据库索引、
