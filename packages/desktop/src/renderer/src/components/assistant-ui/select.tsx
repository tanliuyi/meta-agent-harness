...
const SelectLabel = ({ className, ...props }: ComponentPropsWithoutRef<typeof SelectPrimitive.Label>) => (
...
const SelectItem = ({ className, children, ...props }: ComponentPropsWithoutRef<typeof SelectPrimitive.Item>) => (
...
const SelectSeparator = ({ className, ...props }: ComponentPropsWithoutRef<typeof SelectPrimitive.Separator>) => (
