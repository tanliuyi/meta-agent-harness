...
export const CHANNELS = {
  ...
  markdownImagesRead: "desktop:markdown-images:read",
  markdownImagesCopy: "desktop:markdown-images:copy",
  ...
  filesCopy: "desktop:files:copy",
  filesCut: "desktop:files:cut",
  filesPaste: "desktop:files:paste",
  filesCreateFolder: "desktop:files:create-folder",
  filesRename: "desktop:files:rename",
  filesRemove: "desktop:files:remove",
  filesWatch: "desktop:files:watch",
  filesUnwatch: "desktop:files:unwatch",
  filesChanged: "desktop:files:changed",
  scmGetSnapshot: "desktop:scm:get-snapshot",
  scmGetDiff: "desktop:scm:get-diff",
  scmStage: "desktop:scm:stage",
  scmUnstage: "desktop:scm:unstage",
  scmDiscard: "desktop:scm:discard",
  scmWatch: "desktop:scm:watch",
  scmUnwatch: "desktop:scm:unwatch",
  scmChanged: "desktop:scm:changed",
  ...
  mainAgentsGetSnapshot: "desktop:main-agents:get-snapshot",
  mainAgentsGetCatalog: "desktop:main-agents:get-catalog",
  mainAgentsMutate: "desktop:main-agents:mutate",
  mainAgentsSetEditorDirty: "desktop:main-agents:set-editor-dirty",
