...
const DEFAULT_EXPORT_COLORS: Record<string, string> = {
	body: "#f5f5f4",
	container: "#ffffff",
	sidebar: "#f0f0ef",
	text: "#202124",
	...
	error: "#b91c1c",
	toolOutput: "#374151",
	toolPendingBg: "#fef3c7",
	toolSuccessBg: "#dcfce7",
	toolErrorBg: "#fee2e2",
	toolDiffAdded: "#166534",
	toolDiffRemoved: "#991b1b",
	toolDiffContext: "#4b5563",
	userMessageBg: "#e8f0fe",
	userMessageText: "#202124",
	thinkingText: "#6b7280",
	customMessageBg: "#f8fafc",
	customMessageLabel: "#334155",
	customMessageText: "#111827",
	mdHeading: "#111827",
	mdLink: "#2563eb",
	mdCode: "#b45309",
	mdCodeBlockBorder: "#d1d5db",
	mdQuote: "#4b5563",
...
function generateThemeVars(): string {
	const colors = DEFAULT_EXPORT_COLORS;
	const lines: string[] = [];
	...
	lines.push(`--exportPageBg: ${derivedColors.pageBg};`);
	lines.push(`--exportCardBg: ${derivedColors.cardBg};`);
	lines.push(`--exportInfoBg: ${derivedColors.infoBg};`);
...
function generateHtml(sessionData: SessionData): string {
	...
	const bodyBg = derivedExportColors.pageBg;
	const containerBg = derivedExportColors.cardBg;
	const infoBg = derivedExportColors.infoBg;
...
/** Tools rendered directly by the HTML template instead of pre-rendered HTML. */
const TEMPLATE_RENDERED_TOOLS = new Set(["bash", "read", "write", "edit", "ls"]);

/**
 * Pre-render custom tools to HTML when a renderer is available.
 */
 ...
 * Used by the desktop runtime export command.
 */
