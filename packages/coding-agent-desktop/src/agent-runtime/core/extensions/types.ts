...
export interface ExtensionContext {
	...
	/** Current run mode. Use "desktop" to guard GUI-only interaction. */
	mode: ExtensionMode;
...
export interface ToolDefinition<TParams extends TSchema = TSchema, TDetails = unknown, _TState = any> {
	...
	parameters: TParams;
	/** Optional argument adapter to prepare raw tool call arguments before schema validation. Must return an object conforming to TParams. */
...
export interface RegisteredCommand {
	...
	description?: string;
	getArgumentCompletions?: (argumentPrefix: string) => string[] | null | Promise<string[] | null>;
