 ...
 * discovery and extension loading stay in the desktop-owned agent runtime.
 */
 ...
 */
export async function buildResourcesSnapshot(options: ResourceSnapshotOptions): Promise<ResourcesSnapshot> {
...
function findSourceInfoForPath(resourcePath: string, metadataByPath: Map<string, PathMetadata>): SourceInfo {
